          ...
          children: [
            ...
            Expanded(
              child: Container(
                ...
                decoration: BoxDecoration(color: colorMapping[order.status.toString().toLowerCase()]!.withOpacity(0.15), borderRadius: borderRadius10),
                child: Text(
                  "${order.status}",
                  textAlign: TextAlign.center,
                  overflow: TextOverflow.ellipsis,
                  style: TextStyle(color: colorMapping[order.status.toString().toLowerCase()], fontFamily: gilroySemiBold, fontSize: 14.sp),
                ),
              ),
            ),
          ],
